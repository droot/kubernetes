...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		Convert_v1alpha1_ContainerSelector_To_settings_ContainerSelector,
		Convert_settings_ContainerSelector_To_v1alpha1_ContainerSelector,
...
func autoConvert_v1alpha1_ContainerSelector_To_settings_ContainerSelector(in *v1alpha1.ContainerSelector, out *settings.ContainerSelector, s conversion.Scope) error {
	out.MatchNames = *(*[]string)(unsafe.Pointer(&in.MatchNames))
	return nil
}

// Convert_v1alpha1_ContainerSelector_To_settings_ContainerSelector is an autogenerated conversion function.
func Convert_v1alpha1_ContainerSelector_To_settings_ContainerSelector(in *v1alpha1.ContainerSelector, out *settings.ContainerSelector, s conversion.Scope) error {
	return autoConvert_v1alpha1_ContainerSelector_To_settings_ContainerSelector(in, out, s)
}

func autoConvert_settings_ContainerSelector_To_v1alpha1_ContainerSelector(in *settings.ContainerSelector, out *v1alpha1.ContainerSelector, s conversion.Scope) error {
	out.MatchNames = *(*[]string)(unsafe.Pointer(&in.MatchNames))
	return nil
}

// Convert_settings_ContainerSelector_To_v1alpha1_ContainerSelector is an autogenerated conversion function.
func Convert_settings_ContainerSelector_To_v1alpha1_ContainerSelector(in *settings.ContainerSelector, out *v1alpha1.ContainerSelector, s conversion.Scope) error {
	return autoConvert_settings_ContainerSelector_To_v1alpha1_ContainerSelector(in, out, s)
}
...
func autoConvert_v1alpha1_PodPresetSpec_To_settings_PodPresetSpec(in *v1alpha1.PodPresetSpec, out *settings.PodPresetSpec, s conversion.Scope) error {
	...
	out.AppContainerSelector = (*settings.ContainerSelector)(unsafe.Pointer(in.AppContainerSelector))
...
func autoConvert_settings_PodPresetSpec_To_v1alpha1_PodPresetSpec(in *settings.PodPresetSpec, out *v1alpha1.PodPresetSpec, s conversion.Scope) error {
	out.Selector = in.Selector
	out.AppContainerSelector = (*v1alpha1.ContainerSelector)(unsafe.Pointer(in.AppContainerSelector))
