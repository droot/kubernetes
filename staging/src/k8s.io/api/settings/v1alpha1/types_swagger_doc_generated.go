...
var map_ContainerSelector = map[string]string{
	"":           "ContainerSelector represents container selector criterion that can be applied on list of v1.Container to select containers.",
	"MatchNames": "MatchNames is a list of container names to be matched to. This selector returns a match if container name matches any of the names in this list. Special string “*” is treated as match ANY. Empty or nil list is treated as match NOTHING.",
}

func (ContainerSelector) SwaggerDoc() map[string]string {
	return map_ContainerSelector
}
...
var map_PodPresetSpec = map[string]string{
	...
	"omitempty":    "AppContainerSelector is a ContainerSelector to select app containers of a PodSpec for injecting information into. If not specified, it will default to EmptyContainerSelector which matches any app-container in the PodSpec.",
