...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1alpha1_ContainerSelector, InType: reflect.TypeOf(&ContainerSelector{})},
...
// DeepCopy_v1alpha1_ContainerSelector is an autogenerated deepcopy function.
func DeepCopy_v1alpha1_ContainerSelector(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if in.AppContainerSelector != nil {
			...
			*out = new(ContainerSelector)
			if err := DeepCopy_v1alpha1_ContainerSelector(*in, *out, c); err != nil {
				return err
			}
		}
		if in.Env != nil {
